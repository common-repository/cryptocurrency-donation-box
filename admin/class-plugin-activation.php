        ...
        <div class="wrap cdbbc-activation-page">
				...
				<form method="POST" action="">
					...
					<label>
						...
						<span><?= sprintf(__('By registering your site with adastracrypto.com(Plugin Author), you are agreeing to these  %sTerms & Conditions%s and %sprivacy policy%s.', 'cdbbc'), '<a href=admin_url() . "admin.php?page=cdbbc-crypto-donations#tab=terms-conditions" target="_blank">', '</a>', '<a href=admin_url() . "admin.php?page=cdbbc-crypto-donations#tab=terms-conditions" target="_blank">', '</a>') ?></span>
					</label>
